    ...
    <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-12 pt-32 sm:pt-40 md:pt-48 pb-20">
        ...
        <div className="mb-12 sm:mb-16">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif text-white mb-4 tracking-tight">Terms of Service</h1>
        ...
        <div className="space-y-8 sm:space-y-10 text-stone-400 text-sm sm:text-base leading-relaxed">
          <section>
            <h2 className="text-2xl sm:text-3xl font-serif text-white mb-4">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-serif text-white mb-4">2. Use License</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-serif text-white mb-4">3. Services</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-serif text-white mb-4">4. User Conduct</h2>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-serif text-white mb-4">5. AI Chat Assistant</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-serif text-white mb-4">6. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-serif text-white mb-4">7. Disclaimer</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-serif text-white mb-4">8. Limitations</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-serif text-white mb-4">9. Accuracy of Materials</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-serif text-white mb-4">10. Links</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-serif text-white mb-4">11. Modifications</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-serif text-white mb-4">12. Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-serif text-white mb-4">13. Contact Information</h2>
            <p>
