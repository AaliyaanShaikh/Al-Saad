    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 sm:p-6 md:p-8 bg-black/90 backdrop-blur-sm overflow-y-auto">
      <div className="relative w-full max-w-4xl bg-[#0a0a0a] border border-white/10 rounded-[1.5rem] sm:rounded-[2rem] md:rounded-[2.5rem] p-6 sm:p-8 md:p-12 shadow-2xl my-8">
        ...
        <div className="mb-8 sm:mb-10">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif text-white mb-4 tracking-tight">Terms of Service</h1>
        ...
        <div className="space-y-6 sm:space-y-8 text-stone-400 text-sm sm:text-base leading-relaxed">
          <section>
            <h2 className="text-xl sm:text-2xl font-serif text-white mb-4">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-serif text-white mb-4">2. Use License</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-serif text-white mb-4">3. Services</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-serif text-white mb-4">4. User Conduct</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-serif text-white mb-4">5. AI Chat Assistant</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-serif text-white mb-4">6. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-serif text-white mb-4">7. Disclaimer</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-serif text-white mb-4">8. Limitations</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-serif text-white mb-4">9. Accuracy of Materials</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-serif text-white mb-4">10. Links</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-serif text-white mb-4">11. Modifications</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-serif text-white mb-4">12. Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-serif text-white mb-4">13. Contact Information</h2>
            <p>
