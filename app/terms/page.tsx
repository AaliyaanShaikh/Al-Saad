    ...
    <div className="bg-paper px-5 pt-32 pb-24 md:px-10 md:pt-40 md:pb-32">
      <div className="mx-auto max-w-3xl">
        <Reveal>
          ...
          <h1 className="display mb-4 text-4xl text-ink md:text-6xl">Terms of Service</h1>
        ...
        <div className="space-y-10 text-sm leading-relaxed text-ink-2">
          <section>
            <h2 className="display mb-3 text-2xl text-ink">1. Agreement</h2>
            <p>
          ...
          <section>
            <h2 className="display mb-3 text-2xl text-ink">2. Services</h2>
            <p>
          ...
          <section>
            <h2 className="display mb-3 text-2xl text-ink">3. Accuracy</h2>
            <p>
          ...
          <section>
            <h2 className="display mb-3 text-2xl text-ink">4. Governing law</h2>
            <p>These Terms are governed by the laws of India.</p>
          </section>
          <section>
            <h2 className="display mb-3 text-2xl text-ink">5. Contact</h2>
