    ...
    <div className="bg-void px-5 pt-32 pb-24 md:px-10 md:pt-40 md:pb-32">
      <div className="mx-auto max-w-3xl">
        <Reveal>
          ...
          <h1 className="display mb-4 text-4xl text-ivory md:text-6xl">Privacy Policy</h1>
        ...
        <div className="space-y-10 text-sm leading-relaxed text-ink-2">
          <section>
            <h2 className="display mb-3 text-2xl text-ivory">1. Introduction</h2>
            <p>
          ...
          <section>
            <h2 className="display mb-3 text-2xl text-ivory">2. Information We Collect</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="display mb-3 text-2xl text-ivory">3. How We Use Information</h2>
            <p>
          ...
          <section>
            <h2 className="display mb-3 text-2xl text-ivory">4. Contact</h2>
            <p>
